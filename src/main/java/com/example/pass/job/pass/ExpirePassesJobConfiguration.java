...
public class ExpirePassesJobConfiguration {
    ...
    public ExpirePassesJobConfiguration(JobBuilderFactory jobBuilderFactory, StepBuilderFactory stepBuilderFactory, EntityManagerFactory entityManagerFactory) {
